...
class Analysis():
    ...
    def compute_rse_stats(self, test_trajectories):
        ...
        for name, map_traj in test_trajectories.items():
            ...
            sh_stats = {
                name+'_sh_diff_mean' : [self.nearest_sh(stats_df['rse_mean'], map_stats[name+'_rse_mean'])],
                name+'_sh_diff_median' : [self.nearest_sh(stats_df['rse_median'], map_stats[name+'_rse_median'])],
