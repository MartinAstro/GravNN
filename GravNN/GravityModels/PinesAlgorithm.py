...
def compute_acc_thread(position, N, mu, a, n1, n2, n1q, n2q, cbar, sbar):
    ...
    # Consequently, F in the paper is actually equal to -a, but all of my calculations used the assumption that F = a so 
    # instead of changing multiplying the acceleration generated by -1, we multiply the potential by -1
