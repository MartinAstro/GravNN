...
def evaluate_sh(planet, N, trajectory, dist_name, sampling_interval, hoppers=False):
    ...
    models = glob.glob("GravNN/Files/GravityModels/Regressed/Bennu/EphemerisDist/BLLS/N_%d/**/%s/*.csv" % (N, str(hoppers)))
    ...
    vis.save(plt.gcf(), directory + "sh_error_orex_shoemaker_"+ str(max_deg) + "_" + dist_name + ".pdf")
