...
def regress_nn(config, sampling_interval, include_hoppers=False):
    ...
    max_radius = planet.radius * 10 #3
    # max_radius = 100000
    min_radius = planet.radius  # Brill radius - some extra room

    config["ref_radius"] = [planet.radius]
    ...
    for k in range(len(trajectories)):
        ...
        x, a, u = get_poly_data(trajectory, planet.stl_200k, remove_point_mass=[False])
