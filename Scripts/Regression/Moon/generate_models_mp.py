...
def regress_nn_model(x, a, x_val, a_val, num_units, pinn):
    ...
    from GravNN.Networks.Configs.Default_Configs import get_default_moon_config, get_default_moon_pinn_config
    ...
    if pinn:
        config = get_default_moon_pinn_config()
    else:
...
def main():
    ...
    df_regressed = "Data/Dataframes/regressed_models_moon.data"
    ...
    sh_df.to_pickle("Data/Dataframes/moon_regress_sh.data")
    nn_df.to_pickle("Data/Dataframes/moon_regress_nn.data")
    pinn_df.to_pickle("Data/Dataframes/moon_regress_pinn.data")
