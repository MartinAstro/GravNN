...
def main():
    ...
    sh_df = pd.read_pickle(
        "Data/Dataframes/Regression/Moon_SH_regression_5000_v1_stats.data",
    )
    ...
    nn_df = pd.read_pickle(
        "Data/Dataframes/Regression/Moon_NN_regression_5000_v2_stats.data",
    )
    pinn_df = pd.read_pickle(
        "Data/Dataframes/Regression/Moon_PINN_regression_5000_v2_stats.data",
    )
