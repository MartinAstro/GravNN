...
def main():
    ...
    #         if remove_deg != -1:
    #             C_lm[0,0] = 1.0
    # base = '/Users/johnmartin/Documents/GraduateSchool/Research/ML_Gravity/GravNN/'
    #         file_name = base + 'Files/GravityModels/Regressed/%s/%s/RLLS_%d_%d_%d.csv' %
    #               (planet.__class__.__name__,trajectory.__class__.__name__, N, M, i-1)
