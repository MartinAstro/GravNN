...
def main():
    ...
    sh_df = pd.read_pickle(
        "Data/Dataframes/Regression/Earth_SH_regression_5000_v2_stats.data",
    )  # gelu w/ exp decay
    nn_df = pd.read_pickle(
        "Data/Dataframes/Regression/Earth_NN_regression_5000_v2_stats.data",
    )
    pinn_df = pd.read_pickle(
        "Data/Dataframes/Regression/Earth_PINN_regression_5000_v2_stats.data",
    )
