...
def journal_timing():
    batch = False
    nn_CPU_df = time_models_in_df('Data/Dataframes/traditional_nn_df.data', 'nn_cpu_time', batch)
    pinn_CPU_df = time_models_in_df('Data/Dataframes/pinn_df.data', 'pinn_cpu_time', batch)
