...
acc_r_scalar = MinMaxScaler(feature_range=val_range)
acc_theta_scalar = MinMaxScaler(feature_range=val_range)
acc_phi_scalar = MinMaxScaler(feature_range=val_range)
...
params['first_unit'] = 128
params['first_neuron'] =  128 #128
