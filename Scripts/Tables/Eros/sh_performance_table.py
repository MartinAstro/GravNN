...
def generate_table(df, category):
    ...
    caption = (
        category
        + " SH Performance as listed by $\bar{e} \pm \sigma (e_{\text{max}})$ where $e$ represents the percent error of the acceleration vectors."
    )
