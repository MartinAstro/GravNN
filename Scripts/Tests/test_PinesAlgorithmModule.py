...
def accuracy():
    ...
    accelerations_x = compute_acc(position_x, degree, planet.mu, planet.radius, n1, n2, n1q, n2q, gravityModel.C_lm, gravityModel.S_lm)
    accelerations_y = compute_acc(position_y, degree, planet.mu, planet.radius, n1, n2, n1q, n2q, gravityModel.C_lm, gravityModel.S_lm)
    accelerations_z = compute_acc(position_z, degree, planet.mu, planet.radius, n1, n2, n1q, n2q, gravityModel.C_lm, gravityModel.S_lm)
    ...
    n1, n2, n1q, n2q = compute_n_matrices(degree)
    accelerations_all = compute_acc(positions_all, degree, planet.mu, planet.radius, n1, n2, n1q, n2q, gravityModel.C_lm, gravityModel.S_lm)
