...
def accuracy():
    ...
    accelerations_x = compute_acc_parallel(position_x, degree, planet.mu, planet.radius, n1, n2, n1q, n2q, gravityModel.C_lm, gravityModel.S_lm)
    accelerations_y = compute_acc_parallel(position_y, degree, planet.mu, planet.radius, n1, n2, n1q, n2q, gravityModel.C_lm, gravityModel.S_lm)
    accelerations_z = compute_acc_parallel(position_z, degree, planet.mu, planet.radius, n1, n2, n1q, n2q, gravityModel.C_lm, gravityModel.S_lm)
    ...
    degree = 4
    positions_all = np.array([planet.radius, 0, 0, 0, planet.radius, 0, 0, 0, planet.radius])
    n1, n2, n1q, n2q = compute_n_matrices(degree)
    accelerations_all = compute_acc_parallel(positions_all, degree, planet.mu, planet.radius, n1, n2, n1q, n2q, gravityModel.C_lm, gravityModel.S_lm)
