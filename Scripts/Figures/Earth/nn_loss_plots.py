...
nn_df = pd.read_pickle('C:\\Users\\John\\Documents\\Research\\ML_Gravity\\Data\\Dataframes\\traditional_nn_df.data')
...
for i in range(0,len(df)):
    ...
    plt.semilogy(poly_y-bias,alpha=1, label=str(row['decay_rate_epoch']) + "_" + str(row['learning_rate']))
