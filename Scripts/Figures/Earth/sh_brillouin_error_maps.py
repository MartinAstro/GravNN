...
def main():
    ...
    Call_r0_gm = SphericalHarmonics(sh_file, degree=1000, trajectory=trajectory)
    ...
    C00_r0_gm = SphericalHarmonics(sh_file, degree=0, trajectory=trajectory)
    C00_a = C00_r0_gm.load().accelerations

    C100_r0_gm = SphericalHarmonics(sh_file, degree=100, trajectory=trajectory)
    C100_a = C100_r0_gm.load().accelerations

    C300_r0_gm = SphericalHarmonics(sh_file, degree=300, trajectory=trajectory)
