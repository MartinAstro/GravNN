...
def main():
    ...
    poly_vis.plot_polyhedron(surface_poly_gm.mesh, np.linalg.norm(surface_poly_gm.accelerations, axis=1))

    poly_vis.plot_position_data(x_train, alpha=0.5)
