...
def main():
    ...
    def nn_pareto_curve(file_name, orbit_name, linestyle=None, marker=None):
        ...
        sub_df = nn_df.sort_values(by='params') # [nn_df['radius_max'] == planet.radius + 1000.0]
    ...
    nn_pareto_curve('N_100000_rand_eros_study.data', orbit_name='Surface', linestyle='--')
    #vis.save(fig, "NN_Brill_Params.pdf")

    # ! PINN Neural Network Results
    nn_pareto_curve('N_100000_rand_eros_PINN_study.data', orbit_name='Surface', marker='o')
