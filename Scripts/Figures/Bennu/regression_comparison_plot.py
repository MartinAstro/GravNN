...
def plot_nn_error(network_type, pinn_type, hoppers, dist_name, sampling_interval, linestyle):
    data_directory = os.path.abspath('.') + \
        "/GravNN/Files/GravityModels/Regressed/Bennu/EphemerisDist/" \
...
def plot_error(dist_name, hoppers, linestyle):
    ...
    sh_directory = os.path.abspath('.') + "/GravNN/Files/GravityModels/Regressed/Bennu/EphemerisDist/BLLS/**/**/%s/" % str(hoppers)
