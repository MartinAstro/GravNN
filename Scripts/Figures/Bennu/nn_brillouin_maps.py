...
from GravNN.Visualization.FigureSupport import clamp, format_potential_as_Nx3
from GravNN.Visualization.MapBase import MapBase


def main():
    directory = os.path.abspath(".") + "/Plots/Asteroid/Bennu/"
    ...
    df, descriptor = (
        pd.read_pickle("Data/Dataframes/useless_070621_v4.data"),
        "[5000,10000]*2500 + [0, 5000]*250",
    )
