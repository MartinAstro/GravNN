...
def plot(df, idx, planet, trajectory):
    ...
    grav_model = SphericalHarmonics(planet.sh_file,30,trajectory).load()
...
def main():
    ...
    high_alt_data = DHGridDist(planet, planet.radius+50000, degree=density_deg)
    plot(df, -3, planet, high_alt_data)
